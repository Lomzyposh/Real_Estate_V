...
export default function HomeDetails() {
    ...
    // --- normalize and destructure property ---
    const {
        street,
        home_type,
        price,
    ...
    const agent = property.agent
        ? {
            ...fallbackAgent,
            ...property.agent, // merge so any real data overrides fallback
        }
        : fallbackAgent;
                    ...
                    <div className="mt-6 flex flex-col md:flex-row justify-between gap-6">
                        ...
                        <div className="flex flex-col flex-1 gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-3 font-[inter]">
                                    {more_text}
                                </p>
