  ...
  return (
    <>
      {showOtpForm ? (
        ...
        <form
          className="w-120 h-110 flex  flex-col justify-center rounded-xl p-5 gap-4 bg-[var(--background)] dark:bg-[var(--dark-background)] shadow-lg shadow-gray-300/50 dark:shadow-black/50 mt-3 relative"
          id="forgotPassForm"
          onSubmit={submitForm}
        >
          <i
            className="bi bi-arrow-left-circle absolute top-5 left-3 text-3xl text-[var(--text)] cursor-pointer hover:text-[#4CAF50]"
            onClick={() => setShowForgotForm(false)}
          ></i>
          <h2 className="text-[var(--text)] text-2xl font-bold font-[Montserrat] dark:text-white">
            Forgot Password?
          </h2>
          ...
          <div>
            <label
              htmlFor="forgotEmailInput"
              className="block text-sm/6 font-medium text-gray-800 dark:text-gray-100"
            >
              Email address
            </label>
            <div className="mt-2">
